...
const Pricing=()=> {
    ...
    const packages=[
        {name:"Start",monthlyPrice:19,yearlyPrice:199 ,description:"A common form of lorem ipsum reads:common form of lorem ipsum reads",green:"/my-project/src/assets/rect.jpg"},
        {name:"Advance",monthlyPrice:19,yearlyPrice:199 ,description:"A common form of lorem ipsum reads:common form of lorem ipsum reads",green:"/my-project/src/assets/rect.jpg"},
        {name:"Premium",monthlyPrice:19,yearlyPrice:199 ,description:"A common form of lorem ipsum reads:common form of lorem ipsum reads",green:"/my-project/src/assets/rect.jpg"},
    ]  
      return (
